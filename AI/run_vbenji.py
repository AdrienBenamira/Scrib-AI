...
tf.app.flags.DEFINE_string('exp_name', 'pretrained_model_tf1.2.1', 'Name for experiment. Logs will be saved in a directory with this name, under log_root.')
...
def main(unused_argv):
  ...
  if hps.mode == 'train':
    ...
    resume = decoder.decode() # decode indefinitely (unless single_pass=True, in which case deocde the dataset exactly once)
    t1=time.time()
